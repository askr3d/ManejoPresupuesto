...
namespace ManejoPresupuesto.Servicios
{
    public interface IRepositorioTransacciones
    {
        ...
        Task<IEnumerable<Transaccion>> ObtenerPorCuentaId(ObtenerTransacccionesPorCuenta modelo);
    ...
    public class RepositorioTransacciones: IRepositorioTransacciones
    {
        ...
        public async Task Crear(Transaccion transaccion)
        {
            ...
            var id = await connection.QuerySingleAsync<int>(
                "Transacciones_Insertar", new {transaccion.UsuarioId, transaccion.FechaTransaccion,
                transaccion.Monto ,transaccion.CategoriaId, transaccion.CuentaId, transaccion.Nota},
                commandType: System.Data.CommandType.StoredProcedure);
            transaccion.Id = id;
        }

        public async Task<IEnumerable<Transaccion>> ObtenerPorCuentaId(
            ObtenerTransacccionesPorCuenta modelo)
        {
            using var connection = new SqlConnection(connectionString);
